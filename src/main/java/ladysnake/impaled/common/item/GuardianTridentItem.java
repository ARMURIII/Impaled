...
public class GuardianTridentItem extends ImpaledTridentItem {
    public GuardianTridentItem(Settings settings, EntityType<? extends ImpaledTridentEntity> entityType) {
